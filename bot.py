...
async def message_router(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if context.user_data.pop('waiting_for_otp')
...
async def run_bot():
    ...
    logger.info("Swiggy Bot starting with conflict resolution...")
    await app.initialize()
    await app.start()
    
    # Force delete any existing webhooks and clear pending updates to avoid conflict
